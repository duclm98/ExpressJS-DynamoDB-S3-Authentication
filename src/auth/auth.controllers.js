...
exports.login = async (req, res) => {
    ...
    const isPasswordValid = await userModel.validPassword(user.username, password);
    if (!isPasswordValid) {
...
exports.refreshToken = async (req, res) => {
    ...
    const verifyRefreshToken = await userModel.verifyRefreshToken(username, refreshToken);
